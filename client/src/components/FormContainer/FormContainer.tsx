        ...
        <div className=' container mx-auto p-2 '>
            <div className=' bg-banner my-8 rounded-xl bg-cover bg-center'>
                <div className=' w-full h-full rounded-xl p-20 backdrop:brightness-50'>
                    ...
                    <p className=' text-white text-center pb-2 text-xl font-extralight'> paste your untidy link to shortern it!</p>
                    <p className='  text-white text-center pb-4 text-sm font-thin'>Free  tool to shortern Url or reduce link , Use  our Url Shortner to create Shortened & neet </p>
                    <form onSubmit={handleSubmit}>
                        <div className=' flex'>
                            <div className=' relative w-full'>
                                <div className=' absolute inset-y-0 flex items-center ps-2 pointer-events-auto text-slate-800'>
                                    UrlShortner.link/
                                </div>
                                <input 
                                    type="text"
